        ...
        <Container>
          <Row className="d-flex">
            <Col className="flex-grow-1">
              ...
              <h5 className="para-custom">
                People who register for the Start-Up Fest will be allotted a 5-minute
                time slot to present their startup in front of potential investors.
              </h5>
            </Col>
          ...
          <Row>
            <Col className="col-card margin-between">
              ...
              <p>
                Pitchers will get a 3 by 3 stall and a chance to <span className="yellow-bg">present their project/idea/startup</span> on stage in front of all the investors.
              </p>
            ...
            <Col className="col-card margin-between">
              ...
              <p>
              Startups/ franchises will get a 2/2 stall 
and <span className="yellow-bg">visibility in front of all the investors</span> coming in. </p>
            ...
            <Col className="col-card">
              ...
              <p>
              Investors will get a chance to talk to all 
              the startups and an opportunity to
              <span className="yellow-bg"> multiply their money by 2-3 times.</span>
               </p>
          ...
          <Row>
            ...
            <Row className="margin-between row-gap">
              <Col className=" col-card2">
                <Row>
                 <Col lg={2}>
                <div className="check"> <FaRegCheckCircle /></div> </Col>
                <Col>
                <p >1000+</p>
                <h4>Participants</h4>
                </Col>
            ...
            <h3 className="title mb-5">India Startup Revolution is here and now! at Ahmedabad September <span className="gradient"> 28 & 29, 2024 </span> </h3>
      ...
      <Container>
        ...
        <Col className="sfg ">
            ...
            <h3 className="title mb-5">Innovation at Bottom of the Pyramid in Rural Innovations 
        ...
        <section className="dark-bg padding-sec">
          <Container>
            <div className="w-70 m-auto">
          <h3 className="title text-center text-white mb-0" style={{lineHeight:'67px'}}>Be a Part of Gujarat's Largest 
          Startup Fest Setting the Pace for Innovation!</h3>
          </div>
          <Row>
          <Col lg="12">
              <div className="banner-btns">
